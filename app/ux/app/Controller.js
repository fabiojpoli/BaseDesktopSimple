...
Ext.define('Ext.ux.app.Controller', {
	...
	constructor: function() {
		...
		me.form = Ext.String.format('window[id={0}module] {0}form', me.module);
    	me.list = Ext.String.format('window[id={0}module] {0}list', me.module);
    	...
    	defaultRefs = [{
			...
			ref		: 'panelDetail',
			selector: 'window[id='+me.module+'module] panel[region=east]'
		}];
	...
	init: function() {
		...
		listeners['window[id='+me.module+'module]'] = {
